    ...
    public static void main(String[] args) {
        ...
        if (secret_Exit_ending == 228)
        {
            ...
            if (fightORpacifist == 82)
            {
                ...
                System.out.println("You decide that killing the wolf is not the correct thing to do.");
                ...
                {
                    System.out.println("you made the jump and got away from the wolf");
                }
                else
                {
                    System.out.println("You tripped anf fell.");
